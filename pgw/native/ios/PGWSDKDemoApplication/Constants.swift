...
struct Constants {
    ...
    static let paymentGlobalInstallmentPaymentPlan = ("Global Installment Payment Plan", "")
    static let paymentLocalInstallmentPaymentPlan = ("Local Installment Payment Plan", "")
